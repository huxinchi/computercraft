...
def getItemCount(slotNum: Optional[int] = None) -> int:
    return eval_lua(b'G:turtle:M:getItemCount', slotNum).take_int()


def getItemSpace(slotNum: Optional[int] = None) -> int:
    return eval_lua(b'G:turtle:M:getItemSpace', slotNum).take_int()


def getItemDetail(slotNum: Optional[int] = None) -> Optional[dict]:
...
def place(signText: Optional[str] = None) -> None:
    return eval_lua(b'G:turtle:M:place', signText).check_bool_error()


def placeUp(signText: Optional[str] = None) -> None:
    return eval_lua(b'G:turtle:M:placeUp', signText).check_bool_error()


def placeDown(signText: Optional[str] = None) -> None:
...
def transferTo(slot: int, quantity: Optional[int] = None) -> None:
    return eval_lua(
